...
## `Overview`
BEAT C♡NNECTI♡N is an interactive site encouraging exploration built with JavaScript. Search, listen, and learn. Find streams, local headlines, weather and time wherever you decide to visit.<br><br>
