...
## `Overview`
BEAT C♡NNECTI♡N is an interactive site encouraging exploration built with JavaScript. Visit, listen, and learn. Find streams, local headlines, weather and time wherever you decide to go.<br><br>
