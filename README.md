...
...once we can see artifacts as crystallized forms of human labor, communication, and value, the importance of how they shape activity becomes clearer. - (Gillespie, 2003). ✨ I created this site with magic, wonder, surprise, and delight in mind. ✨ It's meant to double as passive technology; thus, the UI/UX is intentionally minimal, elements dim depending on the user's interactions, and there is a subtle rotation on the canvas.
